...
def test_compact_fixture_is_one_validated_slide_with_one_semantic_beat():
    ...
    assert deck.id == "motorcycle-controls-one-slide"
...
def test_missing_fixture_fails_at_the_repository_boundary(tmp_path):
    from voice_presentation.content.repository import JsonMaterialRepository
